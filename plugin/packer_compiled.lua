...
_G.packer_plugins = {
  ...
  indentLine = {
    loaded = true,
    path = "/Users/asenchi/.local/share/nvim/site/pack/packer/start/indentLine",
  ...
  ["mkdnflow.nvim"] = {
    ...
    loaded = true,
    path = "/Users/asenchi/.local/share/nvim/site/pack/packer/start/mkdnflow.nvim",
  ...
  ["nvim-web-devicons"] = {
    loaded = true,
    path = "/Users/asenchi/.local/share/nvim/site/pack/packer/start/nvim-web-devicons",
  ...
  ["toggleterm.nvim"] = {
    ...
    loaded = true,
    path = "/Users/asenchi/.local/share/nvim/site/pack/packer/start/toggleterm.nvim",
